...
const Sidebar = ({ data }) => {
  ...
  return (
    <div className="bg-black flex flex-col content-between w-full h-auto sm:justify-around sm:w-1/3 sm:fixed">
	  ...
	  className='rounded-full h-full mb-6'
	   src='/images/776ebc58-0385-4491-835a-01e7b341e1f0.jpg' alt="test-resume" aria-label="resume"
	  />
      ...
      <div className="text-white text-center mb-4 mt-4 sm:mt-8">
        <h3 className="mb-2 items-center">CONTACT ME</h3>
